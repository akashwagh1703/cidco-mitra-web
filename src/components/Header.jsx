...
import { Menu, X, Moon, Sun, Globe, Home, Briefcase, Info, MessageSquare } from 'lucide-react'
          ...
          <div className="flex items-center justify-between">
            <Link to="/" className="flex items-center gap-3">
              <div className="text-white">
                <h1 className="text-xl md:text-2xl font-bold leading-tight">सिडकोमित्र</h1>
              ...
              {navLinks.map(link => (
                <Link
                  ...
                  className={`text-white hover:text-gray-200 transition font-medium ${
                    location.pathname === link.path ? 'border-b-2 border-white font-semibold' : ''
                  }`}
                >
                  {link.label}
                </Link>
